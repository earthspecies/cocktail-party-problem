...
if __name__ == '__main__':
	...
	X_train = torch.Tensor(np.load(root+f'{args.data}/Classifier/X_train.npy'))
	Y_train = torch.LongTensor(np.load(root+f'{args.data}/Classifier/Y_train.npy'))

	X_test = torch.Tensor(np.load(root+f'{args.data}/Classifier/X_test.npy'))
	Y_test = torch.LongTensor(np.load(root+f'{args.data}/Classifier/Y_test.npy'))
